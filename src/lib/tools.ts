...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    tagline: "Cracked, glitch, Windows BSOD, Mac, iOS and Android crash screens to prank friends.",
    description:
      "Free fake broken screen prank. Show a realistic shattered screen, glitch, Windows blue screen of death, Mac kernel panic, iOS recovery, or Android crash full-screen — tap anywhere to reveal it's fake.",
    category: "fun",
    icon: "💥",
    keywords: [
      "fake broken screen",
    ...
    howTo: [
      "Use ← / → to pick an effect: cracked, glitch, Windows BSOD, Mac crash, iOS recovery, or Android crash.",
  ...
  },
  {
    ...
    tagline: "Matrix rain, starfield, clock, and the classic DVD logo, full-screen.",
    description:
      "Free online screensaver. Run a matrix rain, starfield, big clock, or the classic bouncing DVD logo full-screen in your browser — no install required.",
    category: "fun",
    icon: "✨",
    keywords: ["online screensaver", "matrix screensaver", "starfield", "dvd bouncing logo", "browser screensaver"],
    howTo: [
      "Choose an effect (matrix, starfield, clock, or the bouncing DVD logo).",
